...
TriggerEvent('es:getPlayerFromId', netID, function(user)
        MySQL.Sync.execute("UPDATE users SET `job` ='10', `police` ='1' WHERE identifier = @user", {['@user'] = user.identifier})
...
TriggerEvent('es:getPlayerFromId', netID, function(user)
        MySQL.Sync.execute("UPDATE users SET `job` ='10', `police` ='2' WHERE identifier = @user", {['@user'] = user.identifier})
...
TriggerEvent('es:getPlayerFromId', netID, function(user)
        MySQL.Sync.execute("UPDATE users SET `job` ='10', `police` ='3' WHERE identifier = @user", {['@user'] = user.identifier})
...
TriggerEvent('es:getPlayerFromId', netID, function(user)
        MySQL.Sync.execute("UPDATE users SET `job` ='10', `police` ='4' WHERE identifier = @user", {['@user'] = user.identifier})
...
TriggerEvent('es:getPlayerFromId', netID, function(user)
        MySQL.Sync.execute("UPDATE users SET `job` ='10', `police` ='5' WHERE identifier = @user", {['@user'] = user.identifier})
